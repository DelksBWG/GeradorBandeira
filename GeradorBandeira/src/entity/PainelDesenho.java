...
public class PainelDesenho  extends JPanel {
	...
	public void paintComponent(Graphics g) {
        ...
        int[] pontosX = {(int) linhas[0].getInicio().getX(), (int)linhas[0].getFim().getX(), 
                (int) linhas[3].getInicio().getX(), (int) linhas[2].getInicio().getX(), 
                (int) linhas[4].getFim().getX(), (int) linhas[1].getInicio().getX()};
        
        int[] pontosY = {(int) linhas[0].getInicio().getY(), (int)linhas[0].getFim().getY(), 
                (int) linhas[3].getInicio().getY(), (int) linhas[2].getInicio().getY(), 
                (int) linhas[4].getFim().getY(), (int) linhas[1].getInicio().getY()};
